...
function ToastItem({ id, title, description, variant, isDestructive, isSuccess, isWarning, dismiss }: any) {
        ...
        >
            ...
            <button
                ...
                className={cn(
                    ...
                    isDestructive ? "text-destructive-foreground/70 hover:text-destructive-foreground" :
                        isSuccess ? "text-emerald-700 hover:text-emerald-900" :
            ...
            <div className="absolute bottom-0 left-0 right-0 h-1 bg-black/10">
                <div
                    className={cn(
                        ...
                        isDestructive ? "bg-destructive-foreground/30" :
                            isSuccess ? "bg-emerald-600/40" :
                                isWarning ? "bg-amber-600/40" :
                                    "bg-primary/40"
                    )}
