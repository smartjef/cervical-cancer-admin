            ...
            <TableBody>
              {isLoading ? (
                ...
                data.map((item) => (
                  <TableRow
                    key={item.id}
                    className="hover:bg-primary/[0.02] border-b transition-colors group"
                  >
                    {columns.map((column, idx) => (
                ...
                <TableRow>
                  <TableCell colSpan={columns.length} className="h-48 text-center">
                    <p className="text-sm text-muted-foreground font-medium uppercase tracking-widest italic">
                      No records found
                    </p>
                  </TableCell>
                </TableRow>
