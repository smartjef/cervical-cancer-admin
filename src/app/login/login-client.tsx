...
export default function LoginPage() {
    ...
    // Add React import if missing or use useEffect globally
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-background dark:bg-card p-4 transition-colors">
            <div className="w-full max-w-[1000px] flex flex-col md:flex-row shadow-2xl overflow-hidden rounded-none border border-border">
                {/* Branding Section */}
                    ...
                    <form onSubmit={handleLogin} className="space-y-5">
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center justify-between">
                                ...
                                <button type="button" className="text-[11px] font-bold text-primary hover:underline uppercase tracking-tight">
                                    Forgot?
                                </button>
                            </div>
                            <Input
                        ...
                        <Button
                            type="submit"
                            className="w-full h-12 bg-primary hover:bg-primary/90 text-white font-bold text-sm shadow-lg shadow-primary/20 transition-all active:scale-[0.98] mt-4"
                            disabled={isLoading}
                        >
                            {isLoading ? (
                                <>
