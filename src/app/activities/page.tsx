...
export default function ActivitiesPage() {
  ...
  const {
    ...
    isLoading,
    refetch,
  } = useApi<any>(`/activities?${queryString}`);
  ...
  const handleExportCSV = () => {
    ...
    link.setAttribute(
      "download",
      `system_activities_${dayjs().format("YYYYMMDD_HHmm")}.csv`,
    );
  ...
  return (
    <DashboardShell
      ...
      subtitle="Full Audit Trail & Logs"
    >
      ...
      {/* --- Filter Bar --- */}
      <Card className="border-none mb-6 bg-card/50 backdrop-blur-sm">
        <CardContent className="p-4 md:p-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-4">
            ...
            <div className="flex items-end pb-0.5">
              <Button
                variant="ghost"
                className="h-10 w-full font-black text-[10px] uppercase tracking-widest hover:bg-red-50 hover:text-red-600 transition-colors"
            ...
            <Table>
              <TableHeader className="bg-muted/30">
                <TableRow className="hover:bg-transparent border-b-2">
                  <TableHead className="w-[180px] font-black text-[10px] uppercase tracking-widest">
                    Time & Date
                  </TableHead>
              ...
              <TableBody>
                {isLoading ? (
                  ...
                  activities.map((activity: any) => (
                    <TableRow
                      key={activity.id}
                      className="group hover:bg-primary/[0.02] border-b transition-colors"
                    >
                      <TableCell>
                        ...
                        <div className="flex flex-col gap-1 max-w-[300px]">
                          ...
                          {activity.metadata?.riskScore !== undefined && (
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-[9px] font-black text-red-600/60 uppercase">
                                {activity.metadata.riskInterpretation?.replace(
                                  "_",
                                  " ",
                                )}
                              </span>
                          ...
                          <Link
                            href={
                              activity.resource === "screening"
                                ? `/screening/${activity.resourceId}`
                                : activity.resource === "client"
                                  ? `/users/clients/${activity.resourceId}`
                  ...
                  <TableRow>
                    <TableCell colSpan={6} className="h-64 text-center">
                      <div className="flex flex-col items-center justify-center py-6 text-center">
                        ...
                        <Button
                          variant="link"
                          className="mt-4 font-black uppercase text-xs text-primary"
                          onClick={handleResetFilters}
                        >
                          Clear all filters
                        </Button>
