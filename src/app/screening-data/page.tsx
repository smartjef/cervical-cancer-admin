        ...
        <DashboardShell title="Screening Analytics" subtitle="Pearl Hospital">
            <div className="flex flex-col md:flex-row gap-4 mb-8">
                <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="space-y-1.5">
                        <label className="text-xs font-bold text-gray-500 uppercase tracking-wider">CHP Filter</label>
                        <Combobox
                            options={[
                    ...
                    <div className="space-y-1.5">
                        <label className="text-xs font-bold text-gray-500 uppercase tracking-wider">Risk Level</label>
                        <Combobox
                            options={[
                ...
                <div className="flex items-end">
                    <Button variant="outline" className="h-11 border-gray-100 text-gray-600 gap-2 font-bold px-6">
            ...
            <Card className="border-none mb-8">
                <CardHeader>
                    <CardTitle className="text-lg font-bold text-gray-700">Screening Trends</CardTitle>
                </CardHeader>
                <CardContent className="h-[400px] flex items-center justify-center bg-gray-50/50 m-6 mt-0 border border-dashed text-gray-400 font-medium">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                {[
                    ...
                    <Card key={item.month} className="border-none text-center">
                        <CardContent className="p-6">
                            <p className="text-2xl font-bold text-gray-800 mb-2">{item.value}</p>
                            <p className="text-sm font-bold text-gray-600">{item.month}</p>
                            <p className="text-[10px] text-gray-400 mt-1 uppercase tracking-wider">Target: {item.target}</p>
                        </CardContent>
                    </Card>
                ))}
            </div>
